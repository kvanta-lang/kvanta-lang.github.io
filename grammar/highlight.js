...
export const quantaHighlight = styleTags({
  ...
  // "pub unsafe async mut extern default move": t.modifier,
   //"for if else loop while match continue break return await": t.definitionKeyword,
  ...
  Number: t.number,
  "FuncName/Name": t.function(t.definition(t.variableName)),
  Name: t.variableName,
  Func: t.keyword,
  Type: t.typeName,
  If: t.keyword,
